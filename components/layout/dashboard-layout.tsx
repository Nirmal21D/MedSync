...
export default function DashboardLayout({ children, role }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex relative">
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-64 bg-sidebar text-sidebar-foreground shadow-xl border-r border-border transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0",
